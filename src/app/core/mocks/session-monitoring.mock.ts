...
export const SESSION_MONITORING_MOCK: SessionMonitoringEvent[] = [
  ...
  },
  {
    ...
    ipOrigen: '192.168.10.15',
    userAgent: 'Chrome Desktop',
    descripcion: 'Actualizacion mock de tipo de cambio USD/PEN.',
    metadata: {
      entidad: 'tipo-cambio',
      accion: 'actualizar',
    },
  ...
  {
    id: 8104,
    sesionId: 'sess-auditor-20260621-003',
    usuarioId: 3,
    usuarioNombre: 'Auditor Luxury',
    usuarioRol: 'AUDITOR',
    tipo: 'PERDIDA_FOCO',
    severidad: 'MEDIA',
    fechaEvento: '2026-06-21T10:02:51',
    ruta: '/audit',
    ipOrigen: '192.168.10.31',
    userAgent: 'Firefox Desktop',
    descripcion: 'La ventana perdio foco durante la revision de auditorias.',
  },
  {
    id: 8105,
  ...
  {
    id: 8106,
    sesionId: 'sess-analista-20260621-005',
    usuarioId: 4,
    usuarioNombre: 'Analista Luxury',
    usuarioRol: 'ANALISTA',
    tipo: 'SALIDA_VIEWPORT',
    severidad: 'MEDIA',
    fechaEvento: '2026-06-21T11:44:11',
    ruta: '/resources/water',
    ipOrigen: '192.168.10.37',
    userAgent: 'Chrome Desktop',
    descripcion: 'El puntero salio del viewport durante el analisis de consumo.',
  },
];
